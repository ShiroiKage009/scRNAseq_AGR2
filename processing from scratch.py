...
#%% reading files
duo_unfilt = sc.read("C:/Work cache/data cache/Aline data/Aline/raw_data/agr2_unfilt_antrum.h5ad")
...
sc.pl.umap(acts, color=['cell_types'])
...
markers.to_csv('test.csv', index = 0)
